...
export class MenuController {
  ...
  @Get()
  @Roles(Role.SUPER_ADMIN, Role.BRAND_MANAGER, ...TENANT_ADMIN_ROLES, Role.SITE_LEAD, Role.CULINARY, Role.CONTROLS)
  ...
  @Roles(Role.SUPER_ADMIN, Role.BRAND_MANAGER, ...TENANT_ADMIN_ROLES, Role.SITE_LEAD, Role.FOH, Role.KITCHEN_STAFF, Role.CUSTOMER, Role.CULINARY, Role.CONTROLS)
  ...
  @Roles(Role.SUPER_ADMIN, Role.BRAND_MANAGER, ...TENANT_ADMIN_ROLES, Role.SITE_LEAD, Role.FOH, Role.KITCHEN_STAFF, Role.CULINARY, Role.CONTROLS)
